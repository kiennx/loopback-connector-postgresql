...
PostgreSQL.prototype.defineProperty = function(model, propertyName, propertyDefinition) {
    var modelDef = this.getModelDefinition(model);
    if (modelDef.properties[propertyName]) {
        Object.assign(modelDef.properties[propertyName], propertyDefinition);
    }
    else {
